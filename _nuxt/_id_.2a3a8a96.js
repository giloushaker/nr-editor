import{u as e}from"./editorStore.4ba9916a.js";import{e as t,a as s,b as o,o as r,i as n}from"./entry.d1e1fbcc.js";const a=t({setup(){return{store:e()}},data(){return{}},computed:{async system(){return await this.store.get_or_load_system(this.$route.params.id)}},methods:{}}),i={class:"ml-20px mt-10px h-full overflow-y-auto"},c=n("pre",null,`This tab is used to run scripts:
...
//# sourceMappingURL=_id_.2a3a8a96.js.map
